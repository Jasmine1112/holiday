<?php
	...
	$faculty_id_input = $_POST['faculty_id_input'];
	...
	$query = "UPDATE users
				SET last_name='$last_name_input', first_name='$first_name_input', email='$email_input', phone_number='$phone_input', school='$school_input', college_department='$department_input', faculty_id='$faculty_id_input'
